      ...
      <div className="main">
        ...
        <div className="calc">
          <div>
            ...
            <input type='text' name='value_inside' placeholder='0 ~ 100' onChange={handleInside} required></input>
          </div>
          <div>
            <label for="value_2nd">필기 점수 *</label>
            <input type='text' name='value_2nd' placeholder='0 ~ 100' onChange={handle1st} required></input>
          </div>
          <div>
            <label for="value_1st">실기 점수 *</label>
            <input type='text' name='value_1st' placeholder='0 ~ 100' onChange={handle2nd} required></input>
          </div>
        </div>
