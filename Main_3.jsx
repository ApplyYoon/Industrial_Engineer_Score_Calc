    ...
    <div className="main">
      ...
      <div className="calc">
        <div>
          ...
          <input type="text" name="value_inside" placeholder="0 ~ 100" onChange={handleInside} required />
        </div>
        <div>
          <label htmlFor="value_2nd">실기 점수 *</label>
          <input type="text" name="value_2nd" placeholder="0 ~ 100" onChange={handle2nd} required />
        </div>
      </div>
